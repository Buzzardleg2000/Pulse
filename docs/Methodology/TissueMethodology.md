...
|-----------------------------------|---------------|------------|--------------------------------------------------------------------|----------------|------------------------------------------------------------------|--------------|-------------------------------------------------------------------|
| Total Fluid Volume (L)            | 39.6          | 36.8       | <span class="success">>1% loss (by weight) @cite gellert2015signs</span> | 34.3           | <span class="success">>2% loss (by weight) @cite gellert2015signs</span> | 31.0         | <span class="success">>5% loss (by weight) @cite gellert2015signs</span> |
